...
function ImagePreview({
  ...
  return (
    <section className="py-1 text-center img-section">
      <div className=" col-11 col-md-10 mx-auto img-col">
        <div className="row img-row">
          <div className="col-md-12  position-relative justify-content-center image-area align-items-center">
